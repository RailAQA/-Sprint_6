...
class TestOrderPage:
    ...
    def test_succesful_order_flow(self, home_page: HomePage, order_page: OrderPage, order_status_page: OrderStatusPage, index):
        ...
        order_status_page.click_samokat_header_logo()
        home_page.check_current_url(url=AppRoute.HOME_PAGE)
